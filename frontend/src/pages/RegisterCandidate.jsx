...
import { registerCandidateAPI } from "../call/auth.jsx";
...
export default function RegisterCandidate() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await registerCandidateAPI(registerRequest);
    ...
    <div className={styles.registerRoot}>
      ...
      >
        ...
        <div className={styles.actionsRow}>
          <button type="button" className={`${styles.socialBtn} ${styles.go}`} onClick={() => navigate("/register-hr")}>
            Register as HR
          </button>
